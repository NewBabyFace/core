...
from menuai.components.image import DOMAIN as IMAGE_DOMAIN, ImageEntity
...
async def _async_create_entities(
    ...
    for definition in definitions:
        ...
        entities.append(StateImageEntity(menuai, definition, unique_id))
    return entities
...
async def async_setup_platform(
    ...
    if "coordinator" in discovery_info:
        async_add_entities(
            TriggerImageEntity(menuai, discovery_info["coordinator"], config)
...
async def async_setup_entry(
    ...
    async_add_entities(
        [StateImageEntity(menuai, validated_config, config_entry.entry_id)]
    )
...
class StateImageEntity(TemplateEntity, ImageEntity):
    ...
    def __init__(
        ...
        TemplateEntity.__init__(self, menuai, config=config, unique_id=unique_id)
        ImageEntity.__init__(self, menuai, config[CONF_VERIFY_SSL])
