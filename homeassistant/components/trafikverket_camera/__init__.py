...
async def async_setup_entry(menuai: menuai, entry: TVCameraConfigEntry) -> bool:
...
async def async_unload_entry(menuai: menuai, entry: TVCameraConfigEntry) -> bool:
    """Unload Trafikverket Camera config entry."""
    return await menuai.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(menuai: menuai, entry: TVCameraConfigEntry) -> bool:
    """Migrate old entry."""
