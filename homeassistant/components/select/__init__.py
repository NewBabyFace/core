...
DATA_COMPONENT: menuaiKey[EntityComponent[SelectEntity]] = menuaiKey(DOMAIN)
...
async def async_setup(menuai: menuai, config: ConfigType) -> bool:
    ...
    component = menuai.data[DATA_COMPONENT] = EntityComponent[SelectEntity](
...
class SelectEntity(Entity, cached_properties=CACHED_PROPERTIES_WITH_ATTR_):
    ...
    async def async_select_option(self, option: str) -> None:
        """Change the selected option."""
        await self.menuai.async_add_executor_job(self.select_option, option)
