...
DATA_COMPONENT: menuaiKey[EntityComponent[EventEntity]] = menuaiKey(DOMAIN)
...
async def async_setup(menuai: menuai, config: ConfigType) -> bool:
    ...
    component = menuai.data[DATA_COMPONENT] = EntityComponent[EventEntity](
...
class EventEntity(RestoreEntity, cached_properties=CACHED_PROPERTIES_WITH_ATTR_):
    ...
    async def async_internal_added_to_menuai(self) -> None:
        """Call when the event entity is added to menuai."""
