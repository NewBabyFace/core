...
async def async_setup_entry(menuai: menuai, entry: IottyConfigEntry) -> bool:
    ...
    data_update_coordinator = IottyDataUpdateCoordinator(menuai, entry, session)
...
async def async_unload_entry(menuai: menuai, entry: IottyConfigEntry) -> bool:
