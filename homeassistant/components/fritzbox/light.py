...
class FritzboxLight(FritzBoxDeviceEntity, LightEntity):
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        if kwargs.get(ATTR_BRIGHTNESS) is not None:
            ...
            await self.menuai.async_add_executor_job(self.data.set_level, level, True)
        ...
        await self.menuai.async_add_executor_job(self.data.set_state_on, True)
        await self.coordinator.async_refresh()

    async def async_turn_off(self, **kwargs: Any) -> None:
        """Turn the light off."""
        await self.menuai.async_add_executor_job(self.data.set_state_off, True)
        await self.coordinator.async_refresh()
