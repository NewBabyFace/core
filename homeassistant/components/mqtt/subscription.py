...
class EntitySubscription:
    ...
    def resubscribe_if_necessary(
        self, menuai: menuai, other: EntitySubscription | None
    ) -> None:
        ...
        if other is not None and other.unsubscribe_callback is not None:
            ...
            debug_info.remove_subscription(self.menuai, str(other.topic), other.entity_id)
        ...
        # Prepare debug data
        debug_info.add_subscription(self.menuai, self.topic, self.entity_id)
...
def async_prepare_subscribe_topics(
    ...
    for key, value in topics.items():
        ...
        requested.resubscribe_if_necessary(menuai, current)
...
async def async_subscribe_topics(
    ...
    async_subscribe_topics_internal(menuai, sub_state)
...
if TYPE_CHECKING:
    ...
    def async_unsubscribe_topics(
        menuai: menuai, sub_state: dict[str, EntitySubscription] | None
    ) -> dict[str, EntitySubscription]:
