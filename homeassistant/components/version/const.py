...
HOME_ASSISTANT: Final = "MenuAI"
POSTFIX_CONTAINER_NAME: Final = "-menuai"
...
VALID_SOURCES: Final[list[str]] = [
    *HA_VERSION_SOURCES,
    "menuaiio",  # Kept to not break existing configurations
