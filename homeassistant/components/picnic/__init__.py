...
from menuai.const import CONF_ACCESS_TOKEN, CONF_COUNTRY_CODE, Platform
...
async def async_setup_entry(menuai: menuai, entry: ConfigEntry) -> bool:
    ...
    picnic_client = await menuai.async_add_executor_job(create_picnic_client, entry)
    picnic_coordinator = PicnicUpdateCoordinator(menuai, picnic_client, entry)
