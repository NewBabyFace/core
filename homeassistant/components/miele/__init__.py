...
async def async_setup_entry(menuai: menuai, entry: MieleConfigEntry) -> bool:
    ...
    auth = AsyncConfigEntryAuth(async_get_clientsession(menuai), session)
    try:
    ...
    coordinator = MieleDataUpdateCoordinator(menuai, auth)
...
async def async_unload_entry(menuai: menuai, entry: MieleConfigEntry) -> bool:
...
async def async_remove_config_entry_device(
    menuai: menuai, config_entry: MieleConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
