...
from menuai.const import CONF_ADDRESS, UnitOfEnergy
...
async def async_setup_entry(
    ...
    coordinator = menuai.data[DOMAIN][config_entry.entry_id][DATA_COORDINATOR]
    meters = menuai.data[DOMAIN][config_entry.entry_id][DATA_SMART_METER].meters
