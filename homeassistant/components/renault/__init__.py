...
async def async_setup_entry(
    menuai: menuai, config_entry: RenaultConfigEntry
) -> bool:
    """Load a config entry."""
    renault_hub = RenaultHub(menuai, config_entry.data[CONF_LOCALE])
    try:
...
async def async_remove_config_entry_device(
    menuai: menuai, config_entry: RenaultConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
