...
class DiscoveryService(Listener):
    ...
    def __init__(
        self, menuai: menuai, config_entry: ConfigEntry, discovery: Discovery
    ) -> None:
        ...
        menuai.data[DOMAIN].setdefault(COORDINATORS, [])
    ...
    async def device_found(self, device_info: DeviceInfo) -> None:
        ...
        coordo = RefossDataUpdateCoordinator(self.menuai, self.config_entry, device)
        self.menuai.data[DOMAIN][COORDINATORS].append(coordo)
    ...
    async def device_update(self, device_info: DeviceInfo) -> None:
        ...
        for coordinator in self.menuai.data[DOMAIN][COORDINATORS]:
