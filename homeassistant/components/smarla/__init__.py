...
async def async_setup_entry(menuai: menuai, entry: FederwiegeConfigEntry) -> bool:
    ...
    federwiege = Federwiege(menuai.loop, connection)
    federwiege.register()
    federwiege.connect()
...
async def async_unload_entry(menuai: menuai, entry: FederwiegeConfigEntry) -> bool:
