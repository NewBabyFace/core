...
async def async_setup_entry(
    menuai: menuai, entry: ElectricKiwiConfigEntry
) -> bool:
    ...
    hop_coordinator = ElectricKiwiHOPDataCoordinator(menuai, entry, ek_api)
    account_coordinator = ElectricKiwiAccountDataCoordinator(menuai, entry, ek_api)
...
async def async_migrate_entry(
    menuai: menuai, config_entry: ElectricKiwiConfigEntry
) -> bool:
    """Migrate old entry."""
