...
FAN_menuai_TO_SB: dict[str | None, str] = {
...
class SwitchBeeClimateEntity(SwitchBeeDeviceEntity[SwitchBeeThermostat], ClimateEntity):
    ...
    def __init__(
        ...
        self._attr_temperature_unit = HVAC_UNIT_SB_TO_menuai[device.temperature_unit]
        self._attr_hvac_modes = [HVAC_MODE_SB_TO_menuai[mode] for mode in device.modes]
    ...
    def _update_attrs_from_coordinator(self) -> None:
        ...
        self._attr_hvac_mode: HVACMode = (
            ...
            else HVAC_MODE_SB_TO_menuai[coordinator_device.mode]
        )
        self._attr_fan_mode = FAN_SB_TO_menuai[coordinator_device.fan]
    ...
    async def async_set_hvac_mode(self, hvac_mode: HVACMode) -> None:
        ...
        if hvac_mode == HVACMode.OFF:
            ...
            await self._operate(
                power=ApiStateCommand.ON, mode=HVAC_MODE_menuai_TO_SB[hvac_mode]
            )
    ...
    async def async_set_fan_mode(self, fan_mode: str) -> None:
        """Set AC fan mode."""
        await self._operate(fan=FAN_menuai_TO_SB[fan_mode])
    ...
    async def _operate(
        ...
        if mode is None:
            mode = HVAC_MODE_menuai_TO_SB[self.hvac_mode]
        if fan is None:
            fan = FAN_menuai_TO_SB[self.fan_mode]
