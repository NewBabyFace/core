...
async def async_setup_entry(
    ...
    async_add_entities(
        (menuaiAqualinkThermostat(dev) for dev in config_entry.runtime_data.thermostats),
        True,
    )


class menuaiAqualinkThermostat(AqualinkEntity[AqualinkThermostat], ClimateEntity):
