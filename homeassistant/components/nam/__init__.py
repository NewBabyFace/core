...
async def async_setup_entry(menuai: menuai, entry: NAMConfigEntry) -> bool:
    ...
    coordinator = NAMDataUpdateCoordinator(menuai, entry, nam)
...
async def async_unload_entry(menuai: menuai, entry: NAMConfigEntry) -> bool:
