...
async def async_setup_entry(menuai: menuai, entry: GiosConfigEntry) -> bool:
    ...
    if isinstance(entry.unique_id, int):
        menuai.config_entries.async_update_entry(entry, unique_id=str(station_id))  # type: ignore[unreachable]
    ...
    coordinator = GiosDataUpdateCoordinator(menuai, entry, gios)
...
async def async_unload_entry(menuai: menuai, entry: GiosConfigEntry) -> bool:
