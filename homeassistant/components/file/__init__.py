...
from menuai.const import CONF_FILE_PATH, CONF_NAME, CONF_PLATFORM, Platform
...
async def async_setup_entry(menuai: menuai, entry: ConfigEntry) -> bool:
    ...
    if filepath and not await menuai.async_add_executor_job(
        menuai.config.is_allowed_path, filepath
    ):
