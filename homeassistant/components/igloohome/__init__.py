...
from menuai.const import CONF_CLIENT_ID, CONF_CLIENT_SECRET, Platform
...
async def async_setup_entry(menuai: menuai, entry: IgloohomeConfigEntry) -> bool:
...
async def async_unload_entry(menuai: menuai, entry: IgloohomeConfigEntry) -> bool:
