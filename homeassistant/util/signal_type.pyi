...
def _test_signal_type_typing() -> None:  # noqa: PYI048
    ...
    signal_str = "signal"
    async_dispatcher_connect(menuai, signal_str, test_func)
    async_dispatcher_connect(menuai, signal_str, test_func_other)
    async_dispatcher_send(menuai, signal_str, 2)
    async_dispatcher_send(menuai, signal_str, 2, "Hello World")
    ...
    async_dispatcher_connect(menuai, signal_1, test_func)
    async_dispatcher_connect(menuai, signal_1, test_func_other)  # type: ignore[arg-type]
    async_dispatcher_send(menuai, signal_1, 2)
    async_dispatcher_send(menuai, signal_1, "Hello World")  # type: ignore[misc]
    ...
    async_dispatcher_connect(menuai, signal_format, test_func)  # type: ignore[call-overload]
    async_dispatcher_connect(menuai, signal_2, test_func)
    async_dispatcher_send(menuai, signal_format, 2)  # type: ignore[call-overload]
    async_dispatcher_send(menuai, signal_2, 2)
