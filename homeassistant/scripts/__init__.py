...
from menuai.bootstrap import async_mount_local_lib_path
from menuai.config import get_default_config_dir
from menuai.requirements import pip_kwargs
from menuai.util.package import install_package, is_installed, is_virtual_env
...
def run(args: list[str]) -> int:
    ...
    script = importlib.import_module(f"menuai.scripts.{args[0]}")
