...
from menuai import __main__ as main
from menuai.const import REQUIRED_PYTHON_VER, RESTART_EXIT_CODE
...
def test_restart_after_backup_restore() -> None:
    ...
    with (
        ...
        patch("menuai.__main__.restore_backup", return_value=True),
    ):
        exit_code = main.main()
