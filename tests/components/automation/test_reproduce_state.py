...
async def test_reproducing_states(
    ...
    menuai.states.async_set("automation.entity_off", "off", {})
    menuai.states.async_set("automation.entity_on", "on", {})

    turn_on_calls = async_mock_service(menuai, "automation", "turn_on")
    turn_off_calls = async_mock_service(menuai, "automation", "turn_off")
    ...
    await async_reproduce_state(menuai, [State("automation.entity_off", "not_supported")])
