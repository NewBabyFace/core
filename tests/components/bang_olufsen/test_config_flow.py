...
async def test_config_flow_timeout_error(
    menuai: menuai, mock_mozart_client: AsyncMock
) -> None:
...
async def test_config_flow_invalid_ip(menuai: menuai) -> None:
...
async def test_config_flow(menuai: menuai, mock_mozart_client: AsyncMock) -> None:
    """Test config flow."""
    ...
    result_user = await menuai.config_entries.flow.async_configure(
...
async def test_config_flow_zeroconf(
    ...
    result_zeroconf = await menuai.config_entries.flow.async_init(
        handler=DOMAIN,
...
async def test_config_flow_zeroconf_not_mozart_device(menuai: menuai) -> None:
...
async def test_config_flow_zeroconf_ipv6(menuai: menuai) -> None:
