...
from menuai.components.metoffice.const import DOMAIN
...
async def test_form(menuai: menuai, requests_mock: requests_mock.Mocker) -> None:
    """Test we get the form."""
    menuai.config.latitude = TEST_LATITUDE_WAVERTREE
    menuai.config.longitude = TEST_LONGITUDE_WAVERTREE
    ...
    with patch(
        "menuai.components.metoffice.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
...
async def test_form_unknown_error(
    menuai: menuai, mock_simple_manager_fail
) -> None:
