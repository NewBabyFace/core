"""Test for a MenuAI bridge that changes light features at runtime."""
...
async def test_light_add_feature_at_runtime(
    ...
    accessories = await setup_accessories_from_file(
        menuai, "home_assistant_bridge_basic_light.json"
    )
    ...
    light_state = menuai.states.get("light.laundry_smoke_ed78")
    ...
    accessories = await setup_accessories_from_file(
        menuai, "home_assistant_bridge_light.json"
    )
