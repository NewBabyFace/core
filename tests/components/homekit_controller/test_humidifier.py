...
async def test_humidifier_active_state(
    ...
    helper = await setup_test_component(menuai, get_next_aid(), create_humidifier_service)
...
async def test_dehumidifier_active_state(
    ...
    helper = await setup_test_component(
        menuai, get_next_aid(), create_dehumidifier_service
    )
...
async def test_migrate_entity_ids(
    ...
    await setup_test_component(menuai, aid, create_humidifier_service)
    assert (
