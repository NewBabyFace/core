...
from menuai.components.dlib_face_identify import CONF_FACES, DOMAIN
from menuai.components.image_processing import DOMAIN as IMAGE_PROCESSING_DOMAIN
from menuai.const import CONF_ENTITY_ID, CONF_PLATFORM, CONF_SOURCE
