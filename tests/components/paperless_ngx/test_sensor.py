...
from menuai.components.paperless_ngx.coordinator import (
...
async def test_sensor_platform(
    ...
    with patch("menuai.components.paperless_ngx.PLATFORMS", [Platform.SENSOR]):
...
async def test_statistic_sensor_state(
    ...
    state = menuai.states.get("sensor.paperless_ngx_total_documents")
