...
def mock_error_handler():
    ...
    with patch("menuai.components.risco.RiscoLocal.add_error_handler") as mock:
        yield mock


async def test_connection_reset(
    menuai: menuai, two_zone_local, mock_error_handler, setup_risco_local
) -> None:
    ...
    with patch.object(menuai.config_entries, "async_reload") as reload_mock:
