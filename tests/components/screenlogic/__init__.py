...
GATEWAY_IMPORT_PATH = "menuai.components.screenlogic.ScreenLogicGateway"
GATEWAY_DISCOVERY_IMPORT_PATH = "menuai.components.screenlogic.coordinator.async_discover_gateways_by_unique_id"
