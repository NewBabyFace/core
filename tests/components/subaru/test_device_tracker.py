...
async def test_device_tracker(
    ...
    assert entry
    actual = menuai.states.get(DEVICE_ID)
    assert (
...
async def test_device_tracker_none_data(menuai: menuai, ev_entry) -> None:
...
async def test_device_tracker_missing_data(menuai: menuai, ev_entry) -> None:
