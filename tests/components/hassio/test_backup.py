...
from menuai.components.menuaiio.backup import RESTORE_JOB_ID_ENV
...
@pytest.fixture(autouse=True)
async def menuaiio_enabled(
    menuai: menuai, supervisor_client: AsyncMock
) -> AsyncGenerator[None]:
    """Enable menuaiio."""
    with (
        patch("menuai.components.backup.is_menuaiio", return_value=True),
        patch("menuai.components.backup.backup.is_menuaiio", return_value=True),
    ):
        yield
...
async def setup_backup_integration(
    menuai: menuai, menuaiio_enabled: None, supervisor_client: AsyncMock
) -> None:
...
async def _setup_backup_platform(
    ...
    *,
    ...
    mock_platform(menuai, f"{domain}.backup", cast(Mock, platform))
...
@pytest.mark.usefixtures("menuaiio_client", "setup_backup_integration")
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            TEST_BACKUP_DETAILS,
            {
                ...
                "agents": {"menuaiio.local": {"protected": False, "size": 1048576}},
                "backup_id": "abc123",
...
async def test_agent_download(
    ...
    resp = await client.get(f"/api/backup/download/{backup_id}?agent_id=menuaiio.local")
...
@pytest.mark.parametrize(
    ...
    [
        (TEST_BACKUP_DETAILS_3, "unknown", "menuaiio.local"),
        (TEST_BACKUP_DETAILS_3, TEST_BACKUP_DETAILS_3.slug, "menuaiio.local"),
        (TEST_BACKUP_DETAILS, TEST_BACKUP_DETAILS_3.slug, "menuaiio.local"),
    ],
)
@pytest.mark.usefixtures("menuaiio_client", "setup_backup_integration")
...
async def test_agent_upload(
    ...
    resp = await client.post(
        "/api/backup/upload?agent_id=menuaiio.local",
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                "success": True,
                "result": {"agent_errors": {"menuaiio.local": "blah"}, "backup": None},
            },
        ),
        (
            SupervisorNotFoundError(),
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                "success": True,
                "result": {"agent_errors": {"menuaiio.local": "blah"}},
            },
        ),
        (
            SupervisorNotFoundError(),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            replace(DEFAULT_BACKUP_OPTIONS, menuai_exclude_database=True),
        ),
        (
...
async def test_reader_writer_create(
    ...
    await client.send_json_auto_id(
        {"type": "backup/generate", "agent_ids": ["menuaiio.local"], "name": "Test"}
...
@pytest.mark.usefixtures("addon_info", "menuaiio_client", "setup_backup_integration")
@pytest.mark.parametrize(
        ...
        supervisor_jobs.Job.from_dict(
            (
                await async_load_json_object_fixture(
                    menuai, "backup_done_with_addon_folder_errors.json", DOMAIN
                )
            )["data"]
        ),
    ]
...
@pytest.mark.parametrize(
    ...
    [
        (
            [],
            None,
            ["menuaiio.local", "menuaiio.share1", "menuaiio.share2", "menuaiio.share3"],
            None,
        ...
        (
            [],
            None,
            ["menuaiio.share1", "menuaiio.local", "menuaiio.share2", "menuaiio.share3"],
            None,
            [LOCATION_LOCAL_STORAGE, "share1", "share2", "share3"],
            False,
            [],
            ...
            [
                {
                    "type": "backup/config/update",
                    "agents": {
                        "menuaiio.local": {"protected": False},
                    },
                }
            ],
            "hunter2",
            ...
            [
                {
                    "type": "backup/config/update",
                    "agents": {
                        "menuaiio.share0": {"protected": False},
                    },
                }
            ],
            "hunter2",
            ["menuaiio.share0", "menuaiio.share1", "menuaiio.share2", "menuaiio.share3"],
            "hunter2",
            ["share1", "share2", "share3"],
            True,
            ["share0"],
            ...
            [
                {
                    ...
                    "agents": {
                        "menuaiio.share0": {"protected": False},
                        "menuaiio.share1": {"protected": False},
                    },
                }
            ],
            "hunter2",
            ...
            [
                {
                    ...
                    "agents": {
                        "menuaiio.share0": {"protected": False},
                        "menuaiio.share1": {"protected": False},
                        "menuaiio.share2": {"protected": False},
                    },
                }
            ],
            "hunter2",
    ...
    [
        (
            {"include_menuai": False},
            {
                ...
                "message": "Cannot create a backup with database but without MenuAI",
            },
        ),
        (
            {"include_menuai": False, "include_database": False},
            {
                "code": "unknown_error",
...
async def test_reader_writer_restore(
    ...
    await client.send_json_auto_id(
        {"type": "backup/restore", "agent_id": "menuaiio.local", "backup_id": "abc123"}
    )
    response = await client.receive_json()
    assert response["event"] == {
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "Cannot restore database without MenuAI",
        ),
        (
            TEST_BACKUP_4,
            TEST_BACKUP_DETAILS_4,
            {"restore_menuai": True, "restore_database": True},
            "Restore database must match backup",
        ),
    ],
)
            ...
            "backup": {
                "data": {
                    ...
                    "config": {
                        ...
                        "create_backup": {
                            "agent_ids": ["test-agent1", "menuaiio.local", "test-agent2"],
