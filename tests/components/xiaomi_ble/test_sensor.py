...
from menuai.components.xiaomi_ble.const import CONF_SLEEPY_DEVICE, DOMAIN
...
async def test_sensors(menuai: menuai) -> None:
    ...
    inject_bluetooth_service_info_bleak(menuai, MMC_T201_1_SERVICE_INFO)
    await menuai.async_block_till_done()
    assert len(menuai.states.async_all()) == 2

    temp_sensor = menuai.states.get("sensor.baby_thermometer_6fc1_temperature")
...
async def test_xiaomi_formaldeyhde(menuai: menuai) -> None:
    ...
    sensor = menuai.states.get("sensor.smart_flower_pot_3e7a_formaldehyde")
...
async def test_xiaomi_consumable(menuai: menuai) -> None:
    ...
    sensor = menuai.states.get("sensor.smart_flower_pot_3e7a_consumable")
    sensor_attr = sensor.attributes
...
async def test_xiaomi_score(menuai: menuai) -> None:
    ...
    sensor = menuai.states.get("sensor.smart_toothbrush_480c_score")
...
async def test_xiaomi_battery_voltage(menuai: menuai) -> None:
    ...
    volt_sensor = menuai.states.get("sensor.smart_flower_pot_3e7a_voltage")
    ...
    bat_sensor = menuai.states.get("sensor.smart_flower_pot_3e7a_battery")
...
async def test_xiaomi_hhccjcy01(menuai: menuai) -> None:
    ...
    illum_sensor = menuai.states.get("sensor.plant_sensor_3e7a_illuminance")
    ...
    cond_sensor = menuai.states.get("sensor.plant_sensor_3e7a_conductivity")
    ...
    moist_sensor = menuai.states.get("sensor.plant_sensor_3e7a_moisture")
    ...
    temp_sensor = menuai.states.get("sensor.plant_sensor_3e7a_temperature")
    temp_sensor_attribtes = temp_sensor.attributes
    ...
    batt_sensor = menuai.states.get("sensor.plant_sensor_3e7a_battery")
...
async def test_xiaomi_hhccjcy01_not_connectable(menuai: menuai) -> None:
...
async def test_xiaomi_xmosb01xs(menuai: menuai) -> None:
    ...
    occupancy_sensor = menuai.states.get("binary_sensor.occupancy_sensor_07b7_occupancy")
    ...
    illum_sensor = menuai.states.get("sensor.occupancy_sensor_07b7_illuminance")
    illum_sensor_attr = illum_sensor.attributes
    ...
    illum_sensor = menuai.states.get("sensor.occupancy_sensor_07b7_duration_detected")
    illum_sensor_attr = illum_sensor.attributes
    ...
    illum_sensor = menuai.states.get("sensor.occupancy_sensor_07b7_duration_cleared")
    illum_sensor_attr = illum_sensor.attributes
    assert illum_sensor.state == "2"
    assert (
        illum_sensor_attr[ATTR_FRIENDLY_NAME]
...
async def test_xiaomi_cgdk2_bind_key(menuai: menuai) -> None:
    """Test CGDK2 bind key.
    ...
    temp_sensor = menuai.states.get("sensor.temperature_humidity_sensor_2089_temperature")
    temp_sensor_attribtes = temp_sensor.attributes
...
async def test_hhccjcy10_uuid(menuai: menuai) -> None:
    """Test HHCCJCY10 UUID.
    ...
    inject_bluetooth_service_info_bleak(menuai, HHCCJCY10_SERVICE_INFO)

    await menuai.async_block_till_done()
    assert len(menuai.states.async_all()) == 5

    temp_sensor = menuai.states.get("sensor.plant_sensor_5bfc_temperature")
    ...
    illu_sensor = menuai.states.get("sensor.plant_sensor_5bfc_illuminance")
    ...
    cond_sensor = menuai.states.get("sensor.plant_sensor_5bfc_conductivity")
    ...
    moist_sensor = menuai.states.get("sensor.plant_sensor_5bfc_moisture")
    ...
    bat_sensor = menuai.states.get("sensor.plant_sensor_5bfc_battery")
    bat_sensor_attr = bat_sensor.attributes
...
async def test_miscale_v1_uuid(menuai: menuai) -> None:
    ...
    inject_bluetooth_service_info_bleak(menuai, MISCALE_V1_SERVICE_INFO)

    await menuai.async_block_till_done()
    assert len(menuai.states.async_all()) == 2

    mass_non_stabilized_sensor = menuai.states.get(
    ...
    mass_sensor = menuai.states.get("sensor.mi_smart_scale_b5dc_weight")
...
async def test_miscale_v2_uuid(menuai: menuai) -> None:
    ...
    inject_bluetooth_service_info_bleak(menuai, MISCALE_V2_SERVICE_INFO)
    ...
    mass_sensor = menuai.states.get("sensor.mi_body_composition_scale_b5dc_weight")
    mass_sensor_attr = mass_sensor.attributes
    ...
    impedance_sensor = menuai.states.get(
