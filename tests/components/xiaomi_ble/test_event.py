...
from menuai.const import ATTR_FRIENDLY_NAME, STATE_ON, STATE_UNAVAILABLE
...
async def test_xiaomi_fingerprint(menuai: menuai) -> None:
    ...
    sensor = menuai.states.get("sensor.door_lock_8a91_key_id")
    ...
    binary_sensor = menuai.states.get("binary_sensor.door_lock_8a91_fingerprint")
    ...
    event = menuai.states.get("event.door_lock_8a91_fingerprint")
...
async def test_xiaomi_lock(menuai: menuai) -> None:
    ...
    binary_sensor = menuai.states.get("binary_sensor.door_lock_8a91_lock")
    binary_sensor_attribtes = binary_sensor.attributes
    assert binary_sensor.state == STATE_ON
