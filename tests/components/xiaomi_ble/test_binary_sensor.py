...
async def test_door_problem_sensors(menuai: menuai) -> None:
    ...
    door_sensor = menuai.states.get("binary_sensor.door_lock_be98_door")
    ...
    door_left_open = menuai.states.get("binary_sensor.door_lock_be98_door_left_open")
    ...
    pry_the_door = menuai.states.get("binary_sensor.door_lock_be98_pry_the_door")
...
async def test_light_motion(menuai: menuai) -> None:
    ...
    motion_sensor = menuai.states.get("binary_sensor.nightlight_9321_motion")
    ...
    light_sensor = menuai.states.get("binary_sensor.nightlight_9321_light")
...
async def test_moisture(menuai: menuai) -> None:
    ...
    sensor = menuai.states.get("binary_sensor.smart_flower_pot_3e7a_moisture")
...
async def test_opening(menuai: menuai) -> None:
    ...
    opening_sensor = menuai.states.get("binary_sensor.door_window_sensor_e567_opening")
...
async def test_opening_problem_sensors(menuai: menuai) -> None:
    ...
    door_left_open = menuai.states.get(
    ...
    device_forcibly_removed = menuai.states.get(
...
async def test_smoke(menuai: menuai) -> None:
    ...
    smoke_sensor = menuai.states.get("binary_sensor.smoke_detector_9cbc_smoke")
...
async def test_power(menuai: menuai) -> None:
    ...
    power_sensor = menuai.states.get("binary_sensor.remote_control_5074_power")
