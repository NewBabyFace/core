...
async def test_deconz_events(
    ...
    assert menuai.states.get("sensor.switch_2_battery").state == "100"
    assert menuai.states.get("sensor.switch_3_battery").state == "100"
    assert menuai.states.get("sensor.switch_4_battery").state == "100"
...
async def test_deconz_alarm_events(
    ...
    captured_events = async_capture_events(menuai, CONF_DECONZ_ALARM_EVENT)
...
async def test_deconz_presence_events(
    ...
    captured_events = async_capture_events(menuai, CONF_DECONZ_PRESENCE_EVENT)
...
async def test_deconz_relative_rotary_events(
    ...
    captured_events = async_capture_events(menuai, CONF_DECONZ_RELATIVE_ROTARY_EVENT)
