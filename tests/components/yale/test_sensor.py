...
async def test_create_doorbell_hardwired(menuai: menuai) -> None:
    ...
    sensor_tmt100_name_battery = menuai.states.get("sensor.tmt100_name_battery")
...
async def test_create_lock_with_low_battery_linked_keypad(
    ...
    state = menuai.states.get("sensor.front_door_lock_keypad_battery")
    ...
    assert (
        menuai.states.get("sensor.a6697750d607098bae8d6baa11ef8063_name_operator").state
        == STATE_UNKNOWN
    )
