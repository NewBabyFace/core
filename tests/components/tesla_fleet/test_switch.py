...
async def test_switch(
    ...
    await setup_platform(menuai, normal_config_entry, [Platform.SWITCH])
...
async def test_switch_offline(
    ...
    await setup_platform(menuai, normal_config_entry, [Platform.SWITCH])
    state = menuai.states.get("switch.test_auto_seat_climate_left")
...
async def test_switch_no_scope(
    ...
    await setup_platform(menuai, readonly_config_entry, [Platform.SWITCH])
