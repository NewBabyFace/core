...
async def test_config_entry_migrations(menuai: menuai) -> None:
...
async def test_async_setup_entry(menuai: menuai) -> None:
    ...
    with patch(
        ...
        state = menuai.states.get("sensor.ups1_status_data")
...
async def test_update_options(menuai: menuai) -> None:
