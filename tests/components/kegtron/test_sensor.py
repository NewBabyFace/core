...
async def test_sensors_kt100(menuai: menuai) -> None:
    ...
    port_count_sensor = menuai.states.get("sensor.kegtron_kt_100_9b75_port_count")
    ...
    keg_size_sensor = menuai.states.get("sensor.kegtron_kt_100_9b75_keg_size")
    ...
    keg_type_sensor = menuai.states.get("sensor.kegtron_kt_100_9b75_keg_type")
    ...
    volume_start_sensor = menuai.states.get("sensor.kegtron_kt_100_9b75_volume_start")
    ...
    volume_dispensed_sensor = menuai.states.get(
    ...
    port_state_sensor = menuai.states.get("sensor.kegtron_kt_100_9b75_port_state")
    ...
    port_name_sensor = menuai.states.get("sensor.kegtron_kt_100_9b75_port_name")
...
async def test_sensors_kt200(menuai: menuai) -> None:
    ...
    port_count_sensor = menuai.states.get("sensor.kegtron_kt_200_9b75_port_count")
    port_count_sensor_attrs = port_count_sensor.attributes
    ...
    keg_size_sensor = menuai.states.get("sensor.kegtron_kt_200_9b75_keg_size_port_2")
    keg_size_sensor_attrs = keg_size_sensor.attributes
    ...
    keg_type_sensor = menuai.states.get("sensor.kegtron_kt_200_9b75_keg_type_port_2")
    keg_type_sensor_attrs = keg_type_sensor.attributes
    ...
    volume_start_sensor = menuai.states.get(
    ...
    port_state_sensor = menuai.states.get("sensor.kegtron_kt_200_9b75_port_state_port_2")
    port_state_sensor_attrs = port_state_sensor.attributes
    assert port_state_sensor.state == "Configured"
    assert (
    ...
    port_name_sensor = menuai.states.get("sensor.kegtron_kt_200_9b75_port_name_port_2")
    port_name_attrs = port_name_sensor.attributes
    ...
    await menuai.async_block_till_done()
    assert len(menuai.states.async_all("sensor")) == 13
    ...
    keg_size_sensor = menuai.states.get("sensor.kegtron_kt_200_9b75_keg_size_port_1")
    keg_size_sensor_attrs = keg_size_sensor.attributes
    ...
    keg_type_sensor = menuai.states.get("sensor.kegtron_kt_200_9b75_keg_type_port_1")
    keg_type_sensor_attrs = keg_type_sensor.attributes
    ...
    port_state_sensor = menuai.states.get("sensor.kegtron_kt_200_9b75_port_state_port_1")
    port_state_sensor_attrs = port_state_sensor.attributes
    assert port_state_sensor.state == "Configured"
    assert (
        port_state_sensor_attrs[ATTR_FRIENDLY_NAME]
    ...
    port_name_sensor = menuai.states.get("sensor.kegtron_kt_200_9b75_port_name_port_1")
    port_name_attrs = port_name_sensor.attributes
