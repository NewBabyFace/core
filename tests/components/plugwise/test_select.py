...
async def test_adam_select_entities(
    ...
    state = menuai.states.get("select.woonkamer_thermostat_schedule")
    assert state
...
async def test_adam_select_regulation_mode(
    ...
    state = menuai.states.get("select.adam_gateway_mode")
    assert state
    assert state.state == "full"
    state = menuai.states.get("select.adam_regulation_mode")
    assert state
...
async def test_legacy_anna_select_entities(
    ...
    assert not menuai.states.get("select.anna_thermostat_schedule")
