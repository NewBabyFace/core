...
from menuai.components.teslemetry.models import TeslemetryData
...
async def test_vehicle_stream(
    ...
    state = menuai.states.get("binary_sensor.test_user_present")
...
async def test_no_live_status(
    ...
    assert menuai.states.get("sensor.energy_site_grid_power") is None
