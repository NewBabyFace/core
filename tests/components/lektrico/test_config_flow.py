...
async def test_user_setup(menuai: menuai, mock_device, mock_setup_entry) -> None:
...
async def test_user_setup_already_exists(
    menuai: menuai, mock_device, mock_config_entry: MockConfigEntry
) -> None:
...
async def test_user_setup_device_offline(menuai: menuai, mock_device) -> None:
...
async def test_discovered_zeroconf(
    menuai: menuai, mock_device, mock_setup_entry
) -> None:
