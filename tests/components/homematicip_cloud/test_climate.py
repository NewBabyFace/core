...
from menuai.components.homematicip_cloud.climate import (
...
async def test_hmip_heating_group_heat(
    ...
    await async_manipulate_test_data(menuai, hmip_device, "actualTemperature", 22.5)
    ...
    await async_manipulate_test_data(menuai, hmip_device, "controlMode", "MANUAL")
    ha_state = menuai.states.get(entity_id)
    ...
    await async_manipulate_test_data(menuai, hmip_device, "controlMode", "AUTO")
    ha_state = menuai.states.get(entity_id)
    assert ha_state.state == HVACMode.AUTO
    ...
    await async_manipulate_test_data(menuai, hmip_device, "boostMode", True)
    ha_state = menuai.states.get(entity_id)
    ...
    await async_manipulate_test_data(menuai, hmip_device, "boostMode", False)
    ha_state = menuai.states.get(entity_id)
    assert ha_state.attributes[ATTR_PRESET_MODE] == "STD"
    ...
    await async_manipulate_test_data(menuai, hmip_device, "controlMode", "ECO")
    ...
    await async_manipulate_test_data(menuai, hmip_device, "controlMode", "AUTOMATIC")
    ha_state = menuai.states.get(entity_id)
    assert ha_state.state == HVACMode.AUTO
    ...
    await async_manipulate_test_data(menuai, hmip_device, "floorHeatingMode", "RADIATOR")
    await async_manipulate_test_data(menuai, hmip_device, "valvePosition", 0.1)
    ha_state = menuai.states.get(entity_id)
    assert ha_state.state == HVACMode.AUTO
    assert ha_state.attributes[ATTR_HVAC_ACTION] == HVACAction.HEATING
    await async_manipulate_test_data(menuai, hmip_device, "floorHeatingMode", "RADIATOR")
    await async_manipulate_test_data(menuai, hmip_device, "valvePosition", 0.0)
    ha_state = menuai.states.get(entity_id)
    assert ha_state.state == HVACMode.AUTO
...
async def test_hmip_heating_group_cool(
    ...
    await async_manipulate_test_data(menuai, hmip_device, "cooling", True)
    await async_manipulate_test_data(menuai, hmip_device, "coolingAllowed", True)
    await async_manipulate_test_data(menuai, hmip_device, "coolingIgnored", False)
    ha_state = menuai.states.get(entity_id)
    ...
    await async_manipulate_test_data(menuai, hmip_device, "cooling", True)
    await async_manipulate_test_data(menuai, hmip_device, "coolingAllowed", False)
    await async_manipulate_test_data(menuai, hmip_device, "coolingIgnored", False)
    ha_state = menuai.states.get(entity_id)
    ...
    await async_manipulate_test_data(menuai, hmip_device, "cooling", True)
    await async_manipulate_test_data(menuai, hmip_device, "coolingAllowed", True)
    await async_manipulate_test_data(menuai, hmip_device, "coolingIgnored", True)
    ha_state = menuai.states.get(entity_id)
...
async def test_hmip_heating_profile_name_not_in_list(
    ...
    with patch(
        "menuai.components.homematicip_cloud.climate.NICE_PROFILE_NAMES",
        return_value={},
    ):
        await menuai.services.async_call(
            "climate",
...
async def test_hmip_climate_services(
    menuai: menuai, mock_hap_with_service
) -> None:
    """Test HomematicipHeatingGroup."""
