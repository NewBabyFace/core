...
@pytest.fixture
async def load_int(menuai: menuai, get_client: NordPoolClient) -> MockConfigEntry:
    """Set up the Nord Pool integration in MenuAI."""
...
async def get_data_from_library(
    ...
    client = NordPoolClient(aioclient_mock.create_session(menuai.loop))
    yield client
