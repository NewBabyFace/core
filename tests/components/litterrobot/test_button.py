...
from menuai.const import ATTR_ENTITY_ID, STATE_UNKNOWN, EntityCategory
...
async def test_button(
    ...
    await setup_integration(menuai, mock_account, BUTTON_DOMAIN)

    state = menuai.states.get(BUTTON_ENTITY)
    assert state
