...
from menuai.components.somfy_mylink.const import (
...
async def test_form_user(menuai: menuai) -> None:
    ...
    with (
        patch(
            "menuai.components.somfy_mylink.config_flow.SomfyMyLinkSynergy.status_info",
            return_value={"any": "data"},
        ),
        patch(
            "menuai.components.somfy_mylink.async_setup_entry",
            return_value=True,
        ) as mock_setup_entry,
    ):
...
async def test_form_user_already_configured(menuai: menuai) -> None:
...
async def test_options_not_loaded(menuai: menuai) -> None:
    ...
    with patch(
        "menuai.components.somfy_mylink.SomfyMyLinkSynergy.status_info",
        return_value={"result": []},
    ):
...
async def test_options_with_targets(menuai: menuai, reversed) -> None:
...
async def test_form_user_already_configured_from_dhcp(menuai: menuai) -> None:
