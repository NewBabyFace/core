...
async def test_sensors(
    ...
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_power_in")
    assert state.state == "0.0"
    assert state.attributes.get(ATTR_DEVICE_CLASS) == SensorDeviceClass.POWER
    assert state.attributes.get(ATTR_UNIT_OF_MEASUREMENT) == UnitOfPower.WATT
    assert state.attributes.get(ATTR_STATE_CLASS) == SensorStateClass.MEASUREMENT
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_current_in")
    assert state.state == "0.0"
    ...
    assert state.attributes.get(ATTR_STATE_CLASS) == SensorStateClass.MEASUREMENT
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_power_out")
    assert state.state == "50.5"
    assert state.attributes.get(ATTR_DEVICE_CLASS) == SensorDeviceClass.POWER
    assert state.attributes.get(ATTR_UNIT_OF_MEASUREMENT) == UnitOfPower.WATT
    assert state.attributes.get(ATTR_STATE_CLASS) == SensorStateClass.MEASUREMENT
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_current_out")
    ...
    assert state.attributes.get(ATTR_STATE_CLASS) == SensorStateClass.MEASUREMENT
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_energy_out")
    ...
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_energy_stored")
    assert state.state == "1330"
    assert state.attributes.get(ATTR_DEVICE_CLASS) == SensorDeviceClass.ENERGY
    assert state.attributes.get(ATTR_UNIT_OF_MEASUREMENT) == UnitOfEnergy.WATT_HOUR
    assert state.attributes.get(ATTR_STATE_CLASS) == SensorStateClass.TOTAL
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_voltage")
    ...
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_state_of_charge_percent")
    assert state.state == "95"
    assert state.attributes.get(ATTR_DEVICE_CLASS) == SensorDeviceClass.BATTERY
    assert state.attributes.get(ATTR_UNIT_OF_MEASUREMENT) == PERCENTAGE
    assert state.attributes.get(ATTR_STATE_CLASS) is None
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_time_to_empty_full")
    ...
    assert state.attributes.get(ATTR_STATE_CLASS) is None
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_temperature")
    assert state.state == "25"
    assert state.attributes.get(ATTR_DEVICE_CLASS) == SensorDeviceClass.TEMPERATURE
    assert state.attributes.get(ATTR_UNIT_OF_MEASUREMENT) == UnitOfTemperature.CELSIUS
    assert state.attributes.get(ATTR_STATE_CLASS) is None
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_wi_fi_strength")
    ...
    assert state.attributes.get(ATTR_STATE_CLASS) is None
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_total_run_time")
    assert state.state == "1720984"
    assert state.attributes.get(ATTR_DEVICE_CLASS) is None
    assert state.attributes.get(ATTR_UNIT_OF_MEASUREMENT) == UnitOfTime.SECONDS
    assert state.attributes.get(ATTR_STATE_CLASS) is None
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_wi_fi_ssid")
    assert state.state == "wifi"
    assert state.attributes.get(ATTR_DEVICE_CLASS) is None
    assert state.attributes.get(ATTR_UNIT_OF_MEASUREMENT) is None
    assert state.attributes.get(ATTR_STATE_CLASS) is None
    state = menuai.states.get(f"sensor.{DEFAULT_NAME}_ip_address")
