...
from menuai.components.water_heater import DOMAIN
...
async def test_action(
    ...
    turn_off_calls = async_mock_service(menuai, "water_heater", "turn_off")
    turn_on_calls = async_mock_service(menuai, "water_heater", "turn_on")
