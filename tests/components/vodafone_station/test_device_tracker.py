...
from menuai.components.vodafone_station.const import SCAN_INTERVAL
from menuai.components.vodafone_station.coordinator import CONSIDER_HOME_SECONDS
...
async def test_all_entities(
    ...
    """Test all entities."""
    with patch(
        "menuai.components.vodafone_station.PLATFORMS", [Platform.DEVICE_TRACKER]
    ):
...
async def test_consider_home(
    ...
    assert (state := menuai.states.get(device_tracker))
