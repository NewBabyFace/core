...
from menuai.components.device_tracker import DOMAIN
from menuai.const import STATE_HOME, EntityCategory
...
async def test_if_state(
    ...
    menuai.states.async_set(entry.entity_id, STATE_HOME)
    ...
    menuai.states.async_set(entry.entity_id, "school")
    menuai.bus.async_fire("test_event1")
    menuai.bus.async_fire("test_event2")
    await menuai.async_block_till_done()
