...
async def test_async_step_bluetooth_valid_device(menuai: menuai) -> None:
    ...
    with patch("menuai.components.bthome.async_setup_entry", return_value=True):
...
async def test_async_step_bluetooth_during_onboarding(menuai: menuai) -> None:
    ...
    with (
        patch(
            "menuai.components.bthome.async_setup_entry", return_value=True
        ) as mock_setup_entry,
        patch(
...
async def test_async_step_bluetooth_not_supported(menuai: menuai) -> None:
...
async def test_async_step_user_no_devices_found_2(menuai: menuai) -> None:
    ...
    """
    with patch(
        "menuai.components.bthome.config_flow.async_discovered_service_info",
...
async def test_async_step_user_replaces_ignored(menuai: menuai) -> None:
...
async def test_async_step_reauth(menuai: menuai) -> None:
...
async def test_async_step_reauth_wrong_key(menuai: menuai) -> None:
