...
from menuai.helpers.translation import LOCALE_EN, async_get_translations
...
async def test_select(
    ...
    select = menuai.states.get(entity_id)
...
async def test_auto_lock_time_translations(menuai: menuai) -> None:
    ...
    translations = await async_get_translations(menuai, LOCALE_EN, "entity", [DOMAIN])
