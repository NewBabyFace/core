...
from menuai.const import CONF_HOST, CONF_WEBHOOK_ID, EVENT_menuai_STOP
...
async def test_config_flow_entry_migrate_2_1(menuai: menuai) -> None:
...
async def test_migration(
    ...
    with patch(
        "menuai.components.tedee.webhook_generate_id",
