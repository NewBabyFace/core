...
from menuai.components.matrix import ATTR_FORMAT, ATTR_IMAGES, DOMAIN, MatrixBot
from menuai.components.matrix.const import FORMAT_HTML, SERVICE_SEND_MESSAGE
...
async def test_send_message(
    ...
    await menuai.services.async_call(DOMAIN, SERVICE_SEND_MESSAGE, data, blocking=True)
