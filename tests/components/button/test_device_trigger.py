...
from menuai.components.button import DOMAIN
...
async def test_if_fires_on_state_change(
    ...
    menuai.states.async_set(entry.entity_id, "unknown")
    ...
    menuai.states.async_set(entry.entity_id, "2021-01-01T23:59:59+00:00")
