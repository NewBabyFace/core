...
from menuai.components.google_generative_ai_conversation.config_flow import (
    RECOMMENDED_OPTIONS,
)
...
async def test_form(menuai: menuai) -> None:
    ...
    menuai.config.components.add("google_generative_ai_conversation")
    MockConfigEntry(
        domain=DOMAIN,
    ...
    with (
        ...
        patch(
            "menuai.components.google_generative_ai_conversation.async_setup_entry",
            return_value=True,
        ) as mock_setup_entry,
    ):
...
async def test_reauth_flow(menuai: menuai) -> None:
    ...
    with (
        ...
        patch(
            "menuai.components.google_generative_ai_conversation.async_unload_entry",
            return_value=True,
    ...
    assert menuai.config_entries.async_entries(DOMAIN)[0].data == {"api_key": "1234"}
