...
from menuai.components.dunehd.const import DOMAIN
...
async def test_user_very_long_host(menuai: menuai) -> None:
...
async def test_create_entry(menuai: menuai) -> None:
    ...
    with (
        patch("menuai.components.dunehd.async_setup_entry"),
...
async def test_create_entry_with_ipv6_address(menuai: menuai) -> None:
