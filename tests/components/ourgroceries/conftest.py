...
from menuai.components.ourgroceries import DOMAIN
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "menuai.components.ourgroceries.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
async def mock_setup_integration(
    ...
    ourgroceries_config_entry.add_to_menuai(menuai)
    with patch(
        "menuai.components.ourgroceries.OurGroceries", return_value=ourgroceries
    ):
