...
async def test_tip_on_off(
    ...
    assert menuai.states.get("binary_sensor.pinecil_soldering_tip").state == STATE_ON
    ...
    assert menuai.states.get("binary_sensor.pinecil_soldering_tip").state == STATE_OFF
