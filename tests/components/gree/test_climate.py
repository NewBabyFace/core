...
from menuai.components.gree.climate import (
    FAN_MODES_REVERSE,
    HVAC_MODES,
    HVAC_MODES_REVERSE,
    GreeClimateEntity,
)
from menuai.components.gree.const import (
...
async def test_discovery_called_once(menuai: menuai, discovery, device) -> None:
...
async def test_discovery_setup(menuai: menuai, discovery, device) -> None:
...
async def test_discovery_setup_connection_error(
    menuai: menuai, discovery, device
) -> None:
...
async def test_discovery_after_setup(
    ...
    await async_setup_gree(menuai)  # Update 1
...
async def test_send_power_on(menuai: menuai, discovery, device) -> None:
...
async def test_send_target_temperature(
    menuai: menuai, discovery, device, units: UnitSystem, temperature
) -> None:
...
async def test_send_target_temperature_with_hvac_mode(
    menuai: menuai, discovery, device, temperature, hvac_mode
) -> None:
...
async def test_send_preset_mode(menuai: menuai, discovery, device, preset) -> None:
...
async def test_send_invalid_preset_mode(menuai: menuai, discovery, device) -> None:
    """Test for sending preset mode command to the device."""
    await async_setup_gree(menuai)
...
async def test_send_preset_mode_device_timeout(
    menuai: menuai, discovery, device, preset
) -> None:
...
async def test_send_hvac_mode(
    menuai: menuai, discovery, device, hvac_mode
) -> None:
...
async def test_send_fan_mode(menuai: menuai, discovery, device, fan_mode) -> None:
...
async def test_send_invalid_fan_mode(menuai: menuai, discovery, device) -> None:
    """Test for sending fan mode command to the device."""
    await async_setup_gree(menuai)
...
async def test_send_fan_mode_device_timeout(
    menuai: menuai, discovery, device, fan_mode
) -> None:
...
async def test_send_swing_mode(
    menuai: menuai, discovery, device, swing_mode
) -> None:
...
async def test_send_invalid_swing_mode(menuai: menuai, discovery, device) -> None:
    """Test for sending swing mode command to the device."""
    await async_setup_gree(menuai)
...
async def test_coordinator_update_handler(
    ...
    entity: GreeClimateEntity = menuai.data[CLIMATE_DOMAIN].get_entity(ENTITY_ID)
...
@patch("menuai.components.gree.PLATFORMS", [CLIMATE_DOMAIN])
...
@patch("menuai.components.gree.PLATFORMS", [CLIMATE_DOMAIN])
async def test_entity_states(menuai: menuai, snapshot: SnapshotAssertion) -> None:
    """Test for entity registry settings (unique_id)."""
    await async_setup_gree(menuai)
