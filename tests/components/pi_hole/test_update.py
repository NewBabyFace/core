...
async def test_update(menuai: menuai) -> None:
    ...
    state = menuai.states.get("update.pi_hole_core_update_available")
    ...
    state = menuai.states.get("update.pi_hole_ftl_update_available")
    ...
    state = menuai.states.get("update.pi_hole_web_update_available")
...
async def test_update_no_versions(menuai: menuai) -> None:
...
async def test_update_no_updates(menuai: menuai) -> None:
