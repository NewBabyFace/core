...
from menuai.components.notify_events.notify import (
    ATTR_LEVEL,
    ATTR_PRIORITY,
    ATTR_TOKEN,
)
...
async def test_send_msg(menuai: menuai) -> None:
    """Test notify.events service."""
    notify_calls = async_mock_service(menuai, NOTIFY_DOMAIN, "events")
