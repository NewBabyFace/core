...
from menuai.components.modern_forms.const import (
    ATTR_SLEEP_TIME,
    DOMAIN,
...
async def test_light_state(
    ...
    state = menuai.states.get("light.modernformsfan_light")
    assert state
...
async def test_light_connection_error(
    ...
    with (
        ...
        patch(
            "menuai.components.modern_forms.coordinator.ModernFormsDevice.light",
