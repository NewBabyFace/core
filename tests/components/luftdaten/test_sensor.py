...
from menuai.components.luftdaten.const import DOMAIN
...
async def test_luftdaten_sensors(
    ...
    state = menuai.states.get("sensor.sensor_12345_temperature")
    assert state
    ...
    state = menuai.states.get("sensor.sensor_12345_humidity")
    assert state
    ...
    state = menuai.states.get("sensor.sensor_12345_pressure")
    assert state
    ...
    state = menuai.states.get("sensor.sensor_12345_pressure_at_sealevel")
    assert state
    ...
    state = menuai.states.get("sensor.sensor_12345_pm10")
    assert state
    ...
    state = menuai.states.get("sensor.sensor_12345_pm2_5")
    assert state
