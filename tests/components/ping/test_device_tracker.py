...
def entity_registry_enabled_by_default() -> Generator[None]:
    ...
    with patch(
        "menuai.components.ping.device_tracker.PingDeviceTracker.entity_registry_enabled_default",
        return_value=True,
    ):
        yield
...
async def test_setup_and_update(
    ...
    state = menuai.states.get("device_tracker.10_10_10_10")
    ...
    assert (state := menuai.states.get("device_tracker.10_10_10_10"))
...
async def test_reload_not_triggering_home(
    ...
    assert menuai.states.get("device_tracker.10_10_10_10").state == "home"
    ...
    with patch(
        ...
        assert menuai.states.get("device_tracker.10_10_10_10").state == "not_home"
