...
from menuai.components.dnsip.sensor import SCAN_INTERVAL
from menuai.config_entries import SOURCE_USER
from menuai.const import CONF_NAME, CONF_PORT, STATE_UNAVAILABLE
...
async def test_sensor(menuai: menuai) -> None:
    ...
    state1 = menuai.states.get("sensor.home_assistant_io")
    state2 = menuai.states.get("sensor.home_assistant_io_ipv6")
...
async def test_legacy_sensor(menuai: menuai) -> None:
...
async def test_sensor_no_response(
    ...
    state = menuai.states.get("sensor.home_assistant_io")
