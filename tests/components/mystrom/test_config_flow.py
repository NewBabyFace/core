...
async def test_form_combined(menuai: menuai, mock_setup_entry: AsyncMock) -> None:
...
async def test_form_duplicates(
    menuai: menuai, mock_setup_entry: AsyncMock, config_entry: MockConfigEntry
) -> None:
...
async def test_wong_answer_from_device(menuai: menuai) -> None:
