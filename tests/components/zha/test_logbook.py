...
from menuai.const import CONF_DEVICE_ID, CONF_UNIQUE_ID, Platform
...
@pytest.fixture
async def mock_devices(menuai: menuai, setup_zha, zigpy_device_mock):
    """IAS device fixture."""
...
async def test_zha_logbook_event_device_with_triggers(
    menuai: menuai, device_registry: dr.DeviceRegistry, mock_devices
) -> None:
