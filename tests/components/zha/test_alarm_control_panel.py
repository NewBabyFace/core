...
async def test_alarm_control_panel(
    ...
    entity_id = find_entity_id(Platform.ALARM_CONTROL_PANEL, zha_device_proxy, menuai)
    ...
    # disarm from HA
    await reset_alarm_panel(menuai, cluster, entity_id)
...
async def reset_alarm_panel(menuai: menuai, cluster: Cluster, entity_id: str):
