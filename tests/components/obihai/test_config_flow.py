...
from menuai.components.obihai.const import DOMAIN
...
VALIDATE_AUTH_PATCH = "menuai.components.obihai.config_flow.validate_auth"

pytestmark = pytest.mark.usefixtures("mock_setup_entry")


async def test_user_form(menuai: menuai, mock_setup_entry: AsyncMock) -> None:
...
async def test_connect_failure(menuai: menuai, mock_gaierror: Generator) -> None:
...
async def test_dhcp_flow_auth_failure(menuai: menuai) -> None:
