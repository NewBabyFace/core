...
async def test_async_step_bluetooth_valid_device(menuai: menuai) -> None:
    ...
    with patch("menuai.components.oralb.async_setup_entry", return_value=True):
...
async def test_async_step_bluetooth_not_oralb(menuai: menuai) -> None:
...
async def test_async_step_user_with_found_devices(menuai: menuai) -> None:
    ...
    with patch(
        "menuai.components.oralb.config_flow.async_discovered_service_info",
