...
from menuai.components.signal_messenger.notify import SignalNotificationService
...
@pytest.fixture
def signal_notification_service(menuai: menuai) -> SignalNotificationService:
    ...
    return SignalNotificationService(menuai, recipients, client)
