...
def patch_mydevolo(credentials_valid: bool, maintenance: bool) -> Generator[None]:
    ...
    with (
        patch(
            "menuai.components.devolo_home_control.Mydevolo.credentials_valid",
            return_value=credentials_valid,
        ),
        patch(
            "menuai.components.devolo_home_control.Mydevolo.maintenance",
            return_value=maintenance,
        ),
        patch(
            "menuai.components.devolo_home_control.Mydevolo.get_gateway_ids",
