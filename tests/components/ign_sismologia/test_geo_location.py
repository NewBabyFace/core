...
from menuai.components.ign_sismologia.geo_location import (
    ATTR_EXTERNAL_ID,
    ATTR_IMAGE_URL,
    ATTR_MAGNITUDE,
...
async def test_setup(menuai: menuai, freezer: FrozenDateTimeFactory) -> None:
    ...
    with patch("georss_client.feed.GeoRssFeed.update") as mock_feed_update:
        ...
        with assert_setup_component(1, geo_location.DOMAIN):
            ...
            state = menuai.states.get("geo_location.m_5_7_region_1")
            ...
            state = menuai.states.get("geo_location.m_4_6")
            assert state is not None
            ...
            state = menuai.states.get("geo_location.region_3")
            assert state is not None
