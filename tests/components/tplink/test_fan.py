...
async def test_states(
    ...
    await setup_platform_for_device(
        menuai, mock_config_entry, Platform.FAN, parent_device
    )
...
async def test_fan_unique_id(
    ...
    await setup_platform_for_device(menuai, mock_config_entry, Platform.FAN, fan)
...
async def test_fan(
    ...
    await setup_platform_for_device(menuai, mock_config_entry, Platform.FAN, device)
