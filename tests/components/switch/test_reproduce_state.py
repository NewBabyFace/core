...
async def test_reproducing_states(
    ...
    menuai.states.async_set("switch.entity_off", "off", {})
    menuai.states.async_set("switch.entity_on", "on", {})

    turn_on_calls = async_mock_service(menuai, "switch", "turn_on")
    turn_off_calls = async_mock_service(menuai, "switch", "turn_off")
    ...
    await async_reproduce_state(menuai, [State("switch.entity_off", "not_supported")])
