...
from menuai.components.tesla_wall_connector.const import (
...
async def create_wall_connector_entry(
    menuai: menuai, side_effect=None, vitals_data=None, lifetime_data=None
) -> MockConfigEntry:
    """Create a wall connector entry in menuai."""
...
async def _test_sensors(
    ...
    await create_wall_connector_entry(
        menuai, vitals_data=vitals_first_update, lifetime_data=lifetime_first_update
    )
