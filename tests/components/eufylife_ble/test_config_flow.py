...
from menuai.components.eufylife_ble.const import DOMAIN
...
async def test_async_step_bluetooth_valid_device(menuai: menuai) -> None:
    ...
    with patch(
        "menuai.components.eufylife_ble.async_setup_entry", return_value=True
    ):
...
async def test_async_step_bluetooth_not_eufylife(menuai: menuai) -> None:
...
async def test_async_step_user_with_found_devices(menuai: menuai) -> None:
    ...
    with patch(
        "menuai.components.eufylife_ble.config_flow.async_discovered_service_info",
