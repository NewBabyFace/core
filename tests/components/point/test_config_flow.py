...
from menuai.components.point.const import DOMAIN, OAUTH2_AUTHORIZE, OAUTH2_TOKEN
...
async def test_full_flow(
    ...
    with patch(
        "menuai.components.point.async_setup_entry", return_value=True
    ) as mock_setup:
...
async def test_reauthentication_flow(
    ...
    with (
        patch("menuai.components.point.api.AsyncConfigEntryAuth"),
        patch(
