...
async def setup_comp(menuai: menuai, cover_only: None) -> None:
...
async def test_toggle_cover(menuai: menuai) -> None:
...
async def test_close_cover_tilt(menuai: menuai) -> None:
...
async def test_open_cover_tilt(menuai: menuai) -> None:
...
async def test_toggle_cover_tilt(menuai: menuai) -> None:
...
async def test_set_cover_tilt_position(menuai: menuai) -> None:
...
async def test_stop_cover_tilt(menuai: menuai) -> None:
