...
from menuai.components.blink import DOMAIN
...
async def test_form(menuai: menuai) -> None:
    ...
    with (
        patch("menuai.components.blink.config_flow.Auth.startup"),
        patch(
            "menuai.components.blink.config_flow.Auth.check_key_required",
            return_value=False,
        ),
        patch(
            "menuai.components.blink.async_setup_entry",
            return_value=True,
        ) as mock_setup_entry,
    ):
...
async def test_form_2fa(menuai: menuai) -> None:
    ...
    with (
        ...
        patch(
            "menuai.components.blink.config_flow.Auth.send_auth_key",
            return_value=True,
        ),
        patch(
            "menuai.components.blink.config_flow.Blink.setup_urls",
            return_value=True,
        ),
        patch(
            "menuai.components.blink.async_setup_entry", return_value=True
        ) as mock_setup_entry,
    ):
...
async def test_form_2fa_connect_error(menuai: menuai) -> None:
...
async def test_form_2fa_invalid_key(menuai: menuai) -> None:
    ...
    with (
        patch(
            "menuai.components.blink.config_flow.Auth.startup",
        ),
        patch(
            "menuai.components.blink.config_flow.Auth.check_key_required",
            return_value=False,
...
async def test_form_2fa_unknown_error(menuai: menuai) -> None:
...
async def test_reauth_shows_user_step(menuai: menuai) -> None:
