...
async def test_unload_entry(
    ...
    assert menuai.services.has_service(DOMAIN, SERVICE_SAVE_VIDEO)
    assert menuai.services.has_service(DOMAIN, SERVICE_SEND_PIN)
...
async def test_migrate_V0(
    ...
    menuai.config_entries.async_update_entry(mock_config_entry, version=0)
